!function(t, e) {
  ...
  return function(t) {
      ...
      if (t = String(t), !(t.length > 100)) {
        ...
        if (e) {
          ...
          switch (r) {
            ...
            case "yr":
            case "y":
              return n * u;case "days":
            case "day":
            case "d":
              return n * p;case "hours":
            case "hour":
            case "hrs":
            case "hr":
            case "h":
              return n * c;case "minutes":
            case "minute":
            case "mins":
            case "min":
            case "m":
              return n * a;case "seconds":
            case "second":
            case "secs":
            case "sec":
            case "s":
              return n * s;case "milliseconds":
            case "millisecond":
            case "msecs":
            case "msec":
            case "ms":
    ...
    function r(t, e) {
      ...
      }), this.timeout(null == e.timeout ? 2e4 : e.timeout), this.readyState = "closed", this.uri = t, this.connecting = [], this.lastPing = null, this.encoding = !1, this.packetBuffer = [];var n = e.parser || c;
    ...
    (function(t) {
      ...
      function s(t, n, r) {
        ...
        o[0] = v[t.type];var s = new k([o.buffer, t.data]);
        return r(s)
      }
      function a(t) {
        try {
      ...
      e.encodePacket = function(e, n, i, a) {
        ...
        for (var o = t, i = []; o.byteLength > 0;) {
          ...
          o = f(o, 2 + c.length), c = parseInt(c);var u = f(o, 0, c);
          if (a) try {
    ...
    (function(e) {
      ...
      function o(t) {
        i.call(this, t), this.query = this.query || {}, a || (e.___eio || (e.___eio = []), a = e.___eio), this.index = a.length;var n = this;
        a.push(function(t) {
          n.onData(t)
    ...
    s(r.prototype), r.prototype.subEvents = function() {
      ...
      return n.options = {}, n.options.compress = !this.flags || !1 !== this.flags.compress, "function" == typeof e[e.length - 1] && (u("emitting packet with ack id %d", this.ids), this.acks[this.ids] = e.pop(), n.id = this.ids++), this.connected ? this.packet(n) : this.sendBuffer.push(n),
        delete this.flags
        , this
    }, r.prototype.packet = function(t) {
      ...
      if (t.nsp === this.nsp) switch (t.type) {
          case i.CONNECT:
            ...
            break;case i.EVENT:
            this.onevent(t);
            break;case i.BINARY_EVENT:
            this.onevent(t);
            break;case i.ACK:
            this.onack(t);
            break;case i.BINARY_ACK:
            this.onack(t);
            break;case i.DISCONNECT:
            this.ondisconnect();
            break;case i.ERROR:
